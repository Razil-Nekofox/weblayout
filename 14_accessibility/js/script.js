...
const linkHidden = document.querySelectorAll('.lang-swither__link');
...
// burgerBtn.addEventListener('click', () =>{linkHidden.classList.toggle('lang-swither__link--Visible');
// });
// burgerClose.addEventListener('click', () => {linkHidden.classList.toggle('lang-swither__link--LinkHidden');
// });
